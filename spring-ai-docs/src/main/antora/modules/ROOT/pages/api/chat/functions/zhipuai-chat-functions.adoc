...
Another option to provide the description of the function is to the `@JsonDescription` annotation on the `MockWeatherService.Request` to provide the function description:
